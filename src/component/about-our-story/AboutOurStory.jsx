...
import image from '../../asset/about/Image (2).png'
  ...
  return (
    <div className='home-our-story'>
      ...
      <div>
        ...
        <p>
          At LetUsBegin, our story is one of purpose and determination. We were founded with a clear mission: to support youths and families living in NYC shelters and break the cycle of homelessness.
          <br />
          <br />
        ...
        <button className='round-button' onClick={() => window.scrollTo(0, 0)}><Link to='/get-involved'>Support Us</Link></button>
      </div>
    </div>
  )
}
